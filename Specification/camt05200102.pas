...
{                                               XML-Datenbindung                                               }
{                                                                                                              }
{         Generiert am: 27.03.2018 15:06:08                                                                    }
{       Generiert von: D:\projekte\src_lnxa6_3thParty\_git_SEPA-for-Delphi\Specification\camt.052.001.02.xsd   }
{                                                                                                              }
{**************************************************************************************************************}
...
{ Forward-Deklarationen }
  ...
  IXMLGenericOrganisationIdentification1List = interface;
  ...
  IXMLGenericPersonIdentification1List = interface;
  IXMLPersonIdentificationSchemeName1Choice = interface;
  IXMLContactDetails2 = interface;
  ...
  IXMLAccountSchemeName1Choice = interface;
  ...
  IXMLClearingSystemMemberIdentification2 = interface;
  IXMLClearingSystemIdentification2Choice = interface;
  IXMLGenericFinancialIdentification1 = interface;
  IXMLFinancialIdentificationSchemeName1Choice = interface;
  IXMLBranchData2 = interface;
  ...
  IXMLStructuredRemittanceInformation7List = interface;
  IXMLReferredDocumentInformation3 = interface;
  IXMLReferredDocumentInformation3List = interface;
  IXMLReferredDocumentType2 = interface;
  IXMLReferredDocumentType1Choice = interface;
  IXMLRemittanceAmount1 = interface;
  IXMLDocumentAdjustment1 = interface;
  IXMLDocumentAdjustment1List = interface;
...
{ IXMLPartyIdentification32 }
  ...
  IXMLPartyIdentification32 = interface(IXMLNode)
    ['{4EA8DA21-2DA3-4CA0-9E04-AB104D45D37F}']
    { Eigenschaftszugriff }
    function Get_Nm: UnicodeString;
    function Get_PstlAdr: IXMLPostalAddress6;
    function Get_Id: IXMLParty6Choice;
    function Get_CtryOfRes: UnicodeString;
    function Get_CtctDtls: IXMLContactDetails2;
    procedure Set_Nm(Value: UnicodeString);
    procedure Set_CtryOfRes(Value: UnicodeString);
    { Methoden & Eigenschaften }
    ...
    property CtryOfRes: UnicodeString read Get_CtryOfRes write Set_CtryOfRes;
    property CtctDtls: IXMLContactDetails2 read Get_CtctDtls;
  end;

{ IXMLPostalAddress6 }

  IXMLPostalAddress6 = interface(IXMLNode)
    ['{63172BF1-E061-4A15-BC08-77B416770135}']
    { Eigenschaftszugriff }
    function Get_AdrTp: UnicodeString;
    function Get_Dept: UnicodeString;
    function Get_SubDept: UnicodeString;
    function Get_StrtNm: UnicodeString;
    function Get_BldgNb: UnicodeString;
    function Get_PstCd: UnicodeString;
    function Get_TwnNm: UnicodeString;
    function Get_CtrySubDvsn: UnicodeString;
    function Get_Ctry: UnicodeString;
    function Get_AdrLine: IXMLMax70TextList;
    procedure Set_AdrTp(Value: UnicodeString);
    procedure Set_Dept(Value: UnicodeString);
    procedure Set_SubDept(Value: UnicodeString);
    procedure Set_StrtNm(Value: UnicodeString);
    procedure Set_BldgNb(Value: UnicodeString);
    procedure Set_PstCd(Value: UnicodeString);
    procedure Set_TwnNm(Value: UnicodeString);
    procedure Set_CtrySubDvsn(Value: UnicodeString);
    procedure Set_Ctry(Value: UnicodeString);
    { Methoden & Eigenschaften }
    property AdrTp: UnicodeString read Get_AdrTp write Set_AdrTp;
    property Dept: UnicodeString read Get_Dept write Set_Dept;
    property SubDept: UnicodeString read Get_SubDept write Set_SubDept;
    property StrtNm: UnicodeString read Get_StrtNm write Set_StrtNm;
    property BldgNb: UnicodeString read Get_BldgNb write Set_BldgNb;
    property PstCd: UnicodeString read Get_PstCd write Set_PstCd;
    property TwnNm: UnicodeString read Get_TwnNm write Set_TwnNm;
    property CtrySubDvsn: UnicodeString read Get_CtrySubDvsn write Set_CtrySubDvsn;
...
{ IXMLParty6Choice }
  ...
  IXMLParty6Choice = interface(IXMLNode)
    ['{51D738AA-D9A6-45E2-B960-F0C6B97D5E92}']
    { Eigenschaftszugriff }
...
{ IXMLGenericOrganisationIdentification1List }

  IXMLGenericOrganisationIdentification1List = interface(IXMLNodeCollection)
    ['{EE3FAEFC-F815-4A59-972D-406C72451B27}']
    { Methoden & Eigenschaften }
    function Add: IXMLGenericOrganisationIdentification1;
    function Insert(const Index: Integer): IXMLGenericOrganisationIdentification1;

    function Get_Item(Index: Integer): IXMLGenericOrganisationIdentification1;
    property Items[Index: Integer]: IXMLGenericOrganisationIdentification1 read Get_Item; default;
  end;

{ IXMLOrganisationIdentificationSchemeName1Choice }

  IXMLOrganisationIdentificationSchemeName1Choice = interface(IXMLNode)
    ['{8DE5A153-B65D-4D64-B080-40F49CCA46D9}']
    { Eigenschaftszugriff }
...
{ IXMLPersonIdentification5 }
  ...
  IXMLPersonIdentification5 = interface(IXMLNode)
    ['{F4CCE4F5-68CF-4E8B-A6EE-45C78F7D4838}']
    { Eigenschaftszugriff }
    function Get_DtAndPlcOfBirth: IXMLDateAndPlaceOfBirth;
    function Get_Othr: IXMLGenericPersonIdentification1List;
    { Methoden & Eigenschaften }
    property DtAndPlcOfBirth: IXMLDateAndPlaceOfBirth read Get_DtAndPlcOfBirth;
    property Othr: IXMLGenericPersonIdentification1List read Get_Othr;
  end;

{ IXMLDateAndPlaceOfBirth }

  IXMLDateAndPlaceOfBirth = interface(IXMLNode)
    ['{D6E634F6-2273-447E-890C-E02B2F91BA04}']
    { Eigenschaftszugriff }
...
{ IXMLGenericPersonIdentification1 }
  ...
  IXMLGenericPersonIdentification1 = interface(IXMLNode)
    ['{C1BED241-09F3-4AE9-9F23-7607AAAAF87D}']
    { Eigenschaftszugriff }
    function Get_Id: UnicodeString;
...
{ IXMLGenericPersonIdentification1List }

  IXMLGenericPersonIdentification1List = interface(IXMLNodeCollection)
    ['{C066EA63-89E2-4594-BC2E-A4D3497989C2}']
    { Methoden & Eigenschaften }
    function Add: IXMLGenericPersonIdentification1;
    function Insert(const Index: Integer): IXMLGenericPersonIdentification1;

    function Get_Item(Index: Integer): IXMLGenericPersonIdentification1;
    property Items[Index: Integer]: IXMLGenericPersonIdentification1 read Get_Item; default;
  end;

{ IXMLPersonIdentificationSchemeName1Choice }

  IXMLPersonIdentificationSchemeName1Choice = interface(IXMLNode)
    ['{EA314DB8-A3CE-48A4-B2DE-24793610F667}']
    { Eigenschaftszugriff }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
    procedure Set_Cd(Value: UnicodeString);
...
{ IXMLContactDetails2 }
  ...
  IXMLContactDetails2 = interface(IXMLNode)
    ['{5B6D2273-1D9D-4D7A-A892-CE361AB05927}']
    { Eigenschaftszugriff }
    function Get_NmPrfx: UnicodeString;
    function Get_Nm: UnicodeString;
    function Get_PhneNb: UnicodeString;
    function Get_MobNb: UnicodeString;
    function Get_FaxNb: UnicodeString;
    function Get_EmailAdr: UnicodeString;
    function Get_Othr: UnicodeString;
    procedure Set_NmPrfx(Value: UnicodeString);
    procedure Set_Nm(Value: UnicodeString);
    procedure Set_PhneNb(Value: UnicodeString);
    procedure Set_MobNb(Value: UnicodeString);
    procedure Set_FaxNb(Value: UnicodeString);
    procedure Set_EmailAdr(Value: UnicodeString);
    procedure Set_Othr(Value: UnicodeString);
    { Methoden & Eigenschaften }
    property NmPrfx: UnicodeString read Get_NmPrfx write Set_NmPrfx;
    property Nm: UnicodeString read Get_Nm write Set_Nm;
    property PhneNb: UnicodeString read Get_PhneNb write Set_PhneNb;
    property MobNb: UnicodeString read Get_MobNb write Set_MobNb;
    property FaxNb: UnicodeString read Get_FaxNb write Set_FaxNb;
    property EmailAdr: UnicodeString read Get_EmailAdr write Set_EmailAdr;
...
{ IXMLAccountIdentification4Choice }
  ...
  IXMLAccountIdentification4Choice = interface(IXMLNode)
    ['{03E1A60A-5E19-44FC-9A6A-D5F1C7CBBEAA}']
    { Eigenschaftszugriff }
...
{ IXMLGenericAccountIdentification1 }
  ...
  IXMLGenericAccountIdentification1 = interface(IXMLNode)
    ['{8BE1AD9B-BBF6-452A-9A3D-10EB72ED68C8}']
    { Eigenschaftszugriff }
    function Get_Id: UnicodeString;
    function Get_SchmeNm: IXMLAccountSchemeName1Choice;
    function Get_Issr: UnicodeString;
    procedure Set_Id(Value: UnicodeString);
    procedure Set_Issr(Value: UnicodeString);
    { Methoden & Eigenschaften }
    property Id: UnicodeString read Get_Id write Set_Id;
    property SchmeNm: IXMLAccountSchemeName1Choice read Get_SchmeNm;
    property Issr: UnicodeString read Get_Issr write Set_Issr;
  end;

{ IXMLAccountSchemeName1Choice }

  IXMLAccountSchemeName1Choice = interface(IXMLNode)
    ['{98B1A543-9EA6-4099-9FEE-9273EEBD1E65}']
    { Eigenschaftszugriff }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
    procedure Set_Cd(Value: UnicodeString);
...
{ IXMLFinancialInstitutionIdentification7 }
  ...
  IXMLFinancialInstitutionIdentification7 = interface(IXMLNode)
    ...
    property ClrSysMmbId: IXMLClearingSystemMemberIdentification2 read Get_ClrSysMmbId;
    property Nm: UnicodeString read Get_Nm write Set_Nm;
    property PstlAdr: IXMLPostalAddress6 read Get_PstlAdr;
    property Othr: IXMLGenericFinancialIdentification1 read Get_Othr;
  end;

{ IXMLClearingSystemMemberIdentification2 }

  IXMLClearingSystemMemberIdentification2 = interface(IXMLNode)
    ['{B3A0906C-DD78-4B82-8616-D2D932B6E407}']
    { Eigenschaftszugriff }
    function Get_ClrSysId: IXMLClearingSystemIdentification2Choice;
    function Get_MmbId: UnicodeString;
    procedure Set_MmbId(Value: UnicodeString);
    { Methoden & Eigenschaften }
    property ClrSysId: IXMLClearingSystemIdentification2Choice read Get_ClrSysId;
    property MmbId: UnicodeString read Get_MmbId write Set_MmbId;
  end;

{ IXMLClearingSystemIdentification2Choice }

  IXMLClearingSystemIdentification2Choice = interface(IXMLNode)
    ['{283FC0BA-58DF-44E0-9A3F-0C8B8112EBED}']
    { Eigenschaftszugriff }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
    procedure Set_Cd(Value: UnicodeString);
...
{ IXMLGenericFinancialIdentification1 }
  ...
  IXMLGenericFinancialIdentification1 = interface(IXMLNode)
    ['{9366A880-BB33-491F-BCC6-A9FCED3D19A1}']
    { Eigenschaftszugriff }
    function Get_Id: UnicodeString;
    function Get_SchmeNm: IXMLFinancialIdentificationSchemeName1Choice;
    function Get_Issr: UnicodeString;
    procedure Set_Id(Value: UnicodeString);
    procedure Set_Issr(Value: UnicodeString);
    { Methoden & Eigenschaften }
    property Id: UnicodeString read Get_Id write Set_Id;
    property SchmeNm: IXMLFinancialIdentificationSchemeName1Choice read Get_SchmeNm;
    property Issr: UnicodeString read Get_Issr write Set_Issr;
  end;

{ IXMLFinancialIdentificationSchemeName1Choice }

  IXMLFinancialIdentificationSchemeName1Choice = interface(IXMLNode)
    ['{9DBD830F-1D85-4DE9-920B-8F950C9C0706}']
    { Eigenschaftszugriff }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
    procedure Set_Cd(Value: UnicodeString);
...
{ IXMLBranchData2 }
  ...
  IXMLBranchData2 = interface(IXMLNode)
    ['{3EB39866-CE84-4D76-A1DD-85237C605DBA}']
    { Eigenschaftszugriff }
    function Get_Id: UnicodeString;
    function Get_Nm: UnicodeString;
    function Get_PstlAdr: IXMLPostalAddress6;
...
{ IXMLCashAccount16 }
  ...
  IXMLCashAccount16 = interface(IXMLNode)
    ['{DA4CC98B-4872-44DA-B5D1-2EEB2DDE9172}']
    { Eigenschaftszugriff }
    function Get_Id: IXMLAccountIdentification4Choice;
    function Get_Tp: IXMLCashAccountType2;
    function Get_Ccy: UnicodeString;
...
{ IXMLActiveOrHistoricCurrencyAndAmount }
  ...
  IXMLActiveOrHistoricCurrencyAndAmount = interface(IXMLNode)
    ['{EBAF4912-6F8F-4873-8D6C-5E93A5FBAE51}']
    { Eigenschaftszugriff }
    function Get_Ccy: UnicodeString;
    procedure Set_Ccy(Value: UnicodeString);
    { Methoden & Eigenschaften }
...
{ IXMLRemittanceInformation5 }
  ...
  IXMLRemittanceInformation5 = interface(IXMLNode)
    ['{03B5A999-ACBF-4B6D-8352-EADB90CDD0BA}']
    { Eigenschaftszugriff }
    function Get_Ustrd: IXMLMax140TextList;
    function Get_Strd: IXMLStructuredRemittanceInformation7List;
    { Methoden & Eigenschaften }
    property Ustrd: IXMLMax140TextList read Get_Ustrd;
    property Strd: IXMLStructuredRemittanceInformation7List read Get_Strd;
  end;

{ IXMLStructuredRemittanceInformation7 }

  IXMLStructuredRemittanceInformation7 = interface(IXMLNode)
    ['{CC6DD38B-59BB-4CC6-BA50-294389279DD0}']
    { Eigenschaftszugriff }
    function Get_RfrdDocInf: IXMLReferredDocumentInformation3List;
    function Get_RfrdDocAmt: IXMLRemittanceAmount1;
    function Get_CdtrRefInf: IXMLCreditorReferenceInformation2;
    function Get_Invcr: IXMLPartyIdentification32;
    function Get_Invcee: IXMLPartyIdentification32;
    function Get_AddtlRmtInf: IXMLMax140TextList;
    { Methoden & Eigenschaften }
    property RfrdDocInf: IXMLReferredDocumentInformation3List read Get_RfrdDocInf;
    property RfrdDocAmt: IXMLRemittanceAmount1 read Get_RfrdDocAmt;
    property CdtrRefInf: IXMLCreditorReferenceInformation2 read Get_CdtrRefInf;
    property Invcr: IXMLPartyIdentification32 read Get_Invcr;
    property Invcee: IXMLPartyIdentification32 read Get_Invcee;
    property AddtlRmtInf: IXMLMax140TextList read Get_AddtlRmtInf;
  end;

{ IXMLStructuredRemittanceInformation7List }

  IXMLStructuredRemittanceInformation7List = interface(IXMLNodeCollection)
    ['{B0FCB6BB-0095-4431-8873-64F0A2D97CD9}']
    { Methoden & Eigenschaften }
    function Add: IXMLStructuredRemittanceInformation7;
    function Insert(const Index: Integer): IXMLStructuredRemittanceInformation7;

    function Get_Item(Index: Integer): IXMLStructuredRemittanceInformation7;
    property Items[Index: Integer]: IXMLStructuredRemittanceInformation7 read Get_Item; default;
  end;

{ IXMLReferredDocumentInformation3 }

  IXMLReferredDocumentInformation3 = interface(IXMLNode)
    ['{143326BE-B677-4C1C-930E-F8C3F5DC9277}']
    { Eigenschaftszugriff }
    function Get_Tp: IXMLReferredDocumentType2;
    function Get_Nb: UnicodeString;
    function Get_RltdDt: UnicodeString;
    procedure Set_Nb(Value: UnicodeString);
    procedure Set_RltdDt(Value: UnicodeString);
    { Methoden & Eigenschaften }
    property Tp: IXMLReferredDocumentType2 read Get_Tp;
    property Nb: UnicodeString read Get_Nb write Set_Nb;
    property RltdDt: UnicodeString read Get_RltdDt write Set_RltdDt;
  end;

{ IXMLReferredDocumentInformation3List }

  IXMLReferredDocumentInformation3List = interface(IXMLNodeCollection)
    ['{D3976B86-FB4E-469F-B5E8-CC43B95D86CA}']
    { Methoden & Eigenschaften }
    function Add: IXMLReferredDocumentInformation3;
    function Insert(const Index: Integer): IXMLReferredDocumentInformation3;

    function Get_Item(Index: Integer): IXMLReferredDocumentInformation3;
    property Items[Index: Integer]: IXMLReferredDocumentInformation3 read Get_Item; default;
  end;

{ IXMLReferredDocumentType2 }

  IXMLReferredDocumentType2 = interface(IXMLNode)
    ['{88D0B103-1FB3-424C-BB4B-F09760D4CE0A}']
    { Eigenschaftszugriff }
    function Get_CdOrPrtry: IXMLReferredDocumentType1Choice;
    function Get_Issr: UnicodeString;
    procedure Set_Issr(Value: UnicodeString);
    { Methoden & Eigenschaften }
    property CdOrPrtry: IXMLReferredDocumentType1Choice read Get_CdOrPrtry;
    property Issr: UnicodeString read Get_Issr write Set_Issr;
  end;

{ IXMLReferredDocumentType1Choice }

  IXMLReferredDocumentType1Choice = interface(IXMLNode)
    ['{A01DAA8D-2B35-4EFD-81C5-211E2AD6B7F1}']
    { Eigenschaftszugriff }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
    procedure Set_Cd(Value: UnicodeString);
...
{ IXMLRemittanceAmount1 }

  IXMLRemittanceAmount1 = interface(IXMLNode)
    ['{CF6B5631-A06B-4CF0-A98C-A852B8F33738}']
    { Eigenschaftszugriff }
    function Get_DuePyblAmt: IXMLActiveOrHistoricCurrencyAndAmount;
    function Get_DscntApldAmt: IXMLActiveOrHistoricCurrencyAndAmount;
    function Get_CdtNoteAmt: IXMLActiveOrHistoricCurrencyAndAmount;
    function Get_TaxAmt: IXMLActiveOrHistoricCurrencyAndAmount;
    function Get_AdjstmntAmtAndRsn: IXMLDocumentAdjustment1List;
    function Get_RmtdAmt: IXMLActiveOrHistoricCurrencyAndAmount;
    { Methoden & Eigenschaften }
    property DuePyblAmt: IXMLActiveOrHistoricCurrencyAndAmount read Get_DuePyblAmt;
    property DscntApldAmt: IXMLActiveOrHistoricCurrencyAndAmount read Get_DscntApldAmt;
    property CdtNoteAmt: IXMLActiveOrHistoricCurrencyAndAmount read Get_CdtNoteAmt;
    property TaxAmt: IXMLActiveOrHistoricCurrencyAndAmount read Get_TaxAmt;
    property AdjstmntAmtAndRsn: IXMLDocumentAdjustment1List read Get_AdjstmntAmtAndRsn;
    property RmtdAmt: IXMLActiveOrHistoricCurrencyAndAmount read Get_RmtdAmt;
  end;

{ IXMLDocumentAdjustment1 }

  IXMLDocumentAdjustment1 = interface(IXMLNode)
    ['{3B8E1002-CD9A-4CB3-8FBB-B976E427E946}']
    { Eigenschaftszugriff }
    function Get_Amt: IXMLActiveOrHistoricCurrencyAndAmount;
    function Get_CdtDbtInd: UnicodeString;
    function Get_Rsn: UnicodeString;
...
{ IXMLDocumentAdjustment1List }

  IXMLDocumentAdjustment1List = interface(IXMLNodeCollection)
    ['{1B5BF50E-6053-4CDF-BDD8-7ABAC6A8CDB4}']
    { Methoden & Eigenschaften }
    function Add: IXMLDocumentAdjustment1;
    function Insert(const Index: Integer): IXMLDocumentAdjustment1;

    function Get_Item(Index: Integer): IXMLDocumentAdjustment1;
    property Items[Index: Integer]: IXMLDocumentAdjustment1 read Get_Item; default;
  end;

{ IXMLCreditorReferenceInformation2 }

  IXMLCreditorReferenceInformation2 = interface(IXMLNode)
    ['{234EB148-086F-41C4-A6BC-172AA34097FF}']
    { Eigenschaftszugriff }
...
{ IXMLCreditorReferenceType2 }
  ...
  IXMLCreditorReferenceType2 = interface(IXMLNode)
    ['{1D5BDD6C-786E-440A-9614-292D516A253E}']
    { Eigenschaftszugriff }
...
{ IXMLCreditorReferenceType1Choice }
  ...
  IXMLCreditorReferenceType1Choice = interface(IXMLNode)
    ['{8DB44E97-06BF-40E7-A7D8-A2BF06D50853}']
    { Eigenschaftszugriff }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
    procedure Set_Cd(Value: UnicodeString);
...
{ IXMLMax70TextList }
  ...
  IXMLMax70TextList = interface(IXMLNodeCollection)
    ['{66E3A8DD-F30E-4913-AC8A-A23016E317BC}']
    { Methoden & Eigenschaften }
...
{ IXMLMax140TextList }
  ...
  IXMLMax140TextList = interface(IXMLNodeCollection)
    ['{111255D3-F0CA-49EA-9FEB-44BD1CD320E8}']
    { Methoden & Eigenschaften }
    function Add(const Value: UnicodeString): IXMLNode;
    function Insert(const Index: Integer; const Value: UnicodeString): IXMLNode;
...
{ IXMLMax105TextList }
  ...
  IXMLMax105TextList = interface(IXMLNodeCollection)
    ['{4C199B7F-F9A1-4D11-8C16-E70DD1014596}']
    { Methoden & Eigenschaften }
    function Add(const Value: UnicodeString): IXMLNode;
    function Insert(const Index: Integer; const Value: UnicodeString): IXMLNode;
...
{ Forward-Deklarationen }
  ...
  TXMLGenericOrganisationIdentification1List = class;
  ...
  TXMLGenericPersonIdentification1List = class;
  TXMLPersonIdentificationSchemeName1Choice = class;
  TXMLContactDetails2 = class;
  ...
  TXMLAccountSchemeName1Choice = class;
  ...
  TXMLClearingSystemMemberIdentification2 = class;
  TXMLClearingSystemIdentification2Choice = class;
  TXMLGenericFinancialIdentification1 = class;
  TXMLFinancialIdentificationSchemeName1Choice = class;
  TXMLBranchData2 = class;
  ...
  TXMLStructuredRemittanceInformation7List = class;
  TXMLReferredDocumentInformation3 = class;
  TXMLReferredDocumentInformation3List = class;
  TXMLReferredDocumentType2 = class;
  TXMLReferredDocumentType1Choice = class;
  TXMLRemittanceAmount1 = class;
  TXMLDocumentAdjustment1 = class;
  TXMLDocumentAdjustment1List = class;
...
{ TXMLOrganisationIdentification4 }
  ...
  private
    FOthr: IXMLGenericOrganisationIdentification1List;
  protected
    { IXMLOrganisationIdentification4 }
    function Get_BICOrBEI: UnicodeString;
    function Get_Othr: IXMLGenericOrganisationIdentification1List;
...
{ TXMLGenericOrganisationIdentification1List }
  ...
  TXMLGenericOrganisationIdentification1List = class(TXMLNodeCollection, IXMLGenericOrganisationIdentification1List)
  protected
    { IXMLGenericOrganisationIdentification1List }
    function Add: IXMLGenericOrganisationIdentification1;
    function Insert(const Index: Integer): IXMLGenericOrganisationIdentification1;
...
{ TXMLPersonIdentification5 }
  ...
  private
    FOthr: IXMLGenericPersonIdentification1List;
  protected
    { IXMLPersonIdentification5 }
    function Get_DtAndPlcOfBirth: IXMLDateAndPlaceOfBirth;
    function Get_Othr: IXMLGenericPersonIdentification1List;
...
{ TXMLGenericPersonIdentification1List }
  ...
  TXMLGenericPersonIdentification1List = class(TXMLNodeCollection, IXMLGenericPersonIdentification1List)
  protected
    { IXMLGenericPersonIdentification1List }
    function Add: IXMLGenericPersonIdentification1;
    function Insert(const Index: Integer): IXMLGenericPersonIdentification1;
...
{ TXMLContactDetails2 }
  ...
  TXMLContactDetails2 = class(TXMLNode, IXMLContactDetails2)
  protected
    { IXMLContactDetails2 }
    function Get_NmPrfx: UnicodeString;
    function Get_Nm: UnicodeString;
...
{ TXMLAccountSchemeName1Choice }
  ...
  TXMLAccountSchemeName1Choice = class(TXMLNode, IXMLAccountSchemeName1Choice)
  protected
    { IXMLAccountSchemeName1Choice }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
...
{ TXMLClearingSystemMemberIdentification2 }
  ...
  TXMLClearingSystemMemberIdentification2 = class(TXMLNode, IXMLClearingSystemMemberIdentification2)
  protected
    { IXMLClearingSystemMemberIdentification2 }
    function Get_ClrSysId: IXMLClearingSystemIdentification2Choice;
    function Get_MmbId: UnicodeString;
...
{ TXMLClearingSystemIdentification2Choice }
  ...
  TXMLClearingSystemIdentification2Choice = class(TXMLNode, IXMLClearingSystemIdentification2Choice)
  protected
    { IXMLClearingSystemIdentification2Choice }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
...
{ TXMLFinancialIdentificationSchemeName1Choice }
  ...
  TXMLFinancialIdentificationSchemeName1Choice = class(TXMLNode, IXMLFinancialIdentificationSchemeName1Choice)
  protected
    { IXMLFinancialIdentificationSchemeName1Choice }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
...
{ TXMLBranchData2 }
  ...
  TXMLBranchData2 = class(TXMLNode, IXMLBranchData2)
  protected
    { IXMLBranchData2 }
    function Get_Id: UnicodeString;
    function Get_Nm: UnicodeString;
...
{ TXMLRemittanceInformation5 }
  ...
  private
    FUstrd: IXMLMax140TextList;
    FStrd: IXMLStructuredRemittanceInformation7List;
  protected
    { IXMLRemittanceInformation5 }
    function Get_Ustrd: IXMLMax140TextList;
    function Get_Strd: IXMLStructuredRemittanceInformation7List;
...
{ TXMLStructuredRemittanceInformation7 }
  ...
  private
    FRfrdDocInf: IXMLReferredDocumentInformation3List;
    FAddtlRmtInf: IXMLMax140TextList;
  protected
    { IXMLStructuredRemittanceInformation7 }
    function Get_RfrdDocInf: IXMLReferredDocumentInformation3List;
    function Get_RfrdDocAmt: IXMLRemittanceAmount1;
...
{ TXMLStructuredRemittanceInformation7List }
  ...
  TXMLStructuredRemittanceInformation7List = class(TXMLNodeCollection, IXMLStructuredRemittanceInformation7List)
  protected
    { IXMLStructuredRemittanceInformation7List }
    function Add: IXMLStructuredRemittanceInformation7;
    function Insert(const Index: Integer): IXMLStructuredRemittanceInformation7;
...
{ TXMLReferredDocumentInformation3 }
  ...
  TXMLReferredDocumentInformation3 = class(TXMLNode, IXMLReferredDocumentInformation3)
  protected
    { IXMLReferredDocumentInformation3 }
    function Get_Tp: IXMLReferredDocumentType2;
    function Get_Nb: UnicodeString;
...
{ TXMLReferredDocumentInformation3List }
  ...
  TXMLReferredDocumentInformation3List = class(TXMLNodeCollection, IXMLReferredDocumentInformation3List)
  protected
    { IXMLReferredDocumentInformation3List }
    function Add: IXMLReferredDocumentInformation3;
    function Insert(const Index: Integer): IXMLReferredDocumentInformation3;
...
{ TXMLReferredDocumentType2 }
  ...
  TXMLReferredDocumentType2 = class(TXMLNode, IXMLReferredDocumentType2)
  protected
    { IXMLReferredDocumentType2 }
    function Get_CdOrPrtry: IXMLReferredDocumentType1Choice;
    function Get_Issr: UnicodeString;
...
{ TXMLReferredDocumentType1Choice }
  ...
  TXMLReferredDocumentType1Choice = class(TXMLNode, IXMLReferredDocumentType1Choice)
  protected
    { IXMLReferredDocumentType1Choice }
    function Get_Cd: UnicodeString;
    function Get_Prtry: UnicodeString;
...
{ TXMLRemittanceAmount1 }
  ...
  TXMLRemittanceAmount1 = class(TXMLNode, IXMLRemittanceAmount1)
  private
    FAdjstmntAmtAndRsn: IXMLDocumentAdjustment1List;
  protected
    { IXMLRemittanceAmount1 }
    function Get_DuePyblAmt: IXMLActiveOrHistoricCurrencyAndAmount;
    function Get_DscntApldAmt: IXMLActiveOrHistoricCurrencyAndAmount;
...
{ TXMLDocumentAdjustment1 }
  ...
  TXMLDocumentAdjustment1 = class(TXMLNode, IXMLDocumentAdjustment1)
  protected
    { IXMLDocumentAdjustment1 }
    function Get_Amt: IXMLActiveOrHistoricCurrencyAndAmount;
    function Get_CdtDbtInd: UnicodeString;
...
{ TXMLDocumentAdjustment1List }
  ...
  TXMLDocumentAdjustment1List = class(TXMLNodeCollection, IXMLDocumentAdjustment1List)
  protected
    { IXMLDocumentAdjustment1List }
    function Add: IXMLDocumentAdjustment1;
    function Insert(const Index: Integer): IXMLDocumentAdjustment1;
...
{ TXMLMax140TextList }
  ...
  TXMLMax140TextList = class(TXMLNodeCollection, IXMLMax140TextList)
  protected
    { IXMLMax140TextList }
    function Add(const Value: UnicodeString): IXMLNode;
    function Insert(const Index: Integer; const Value: UnicodeString): IXMLNode;
...
function GetDocument(Doc: IXMLDocument): IXMLDocument05200102;
function LoadDocument(const FileName: string): IXMLDocument05200102;
function NewDocument: IXMLDocument05200102;
...
function GetDocument(Doc: IXMLDocument): IXMLDocument05200102;
begin
  Result := Doc.GetDocBinding('Document', TXMLDocument05200102, TargetNamespace) as IXMLDocument05200102;
end;

function LoadDocument(const FileName: string): IXMLDocument05200102;
begin
  Result := LoadXMLDocument(FileName).GetDocBinding('Document', TXMLDocument05200102, TargetNamespace) as IXMLDocument05200102;
end;

function NewDocument: IXMLDocument05200102;
begin
  Result := NewXMLDocument.GetDocBinding('Document', TXMLDocument05200102, TargetNamespace) as IXMLDocument05200102;
end;
...
function TXMLMax140TextList.Add(const Value: UnicodeString): IXMLNode;
begin
  Result := AddItem(-1);
  Result.NodeValue := Value;
end;

function TXMLMax140TextList.Insert(const Index: Integer; const Value: UnicodeString): IXMLNode;
begin
  Result := AddItem(Index);
  Result.NodeValue := Value;
end;

function TXMLMax140TextList.Get_Item(Index: Integer): UnicodeString;
begin
  Result := List[Index].NodeValue;
end;
